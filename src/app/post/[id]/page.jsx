...
async function getPost(id) {
  const rawUrl = `${process.env.BASE_URL}posts/${id}?populate[0]=cover&populate[1]=designers&populate[2]=brandings&populate[3]=photographs&populate[4]=contents.blockImage`;
